...
constructor(
    ...
    override suspend fun deleteShop(cacheShop: CacheShop): Int =
        localDataSource.deleteShop(cacheShop)
    ...
    override suspend fun deleteItem(cacheItem: CacheItem): Int =
        localDataSource.deleteItem(cacheItem)
    ...
    override suspend fun refreshCacheDatabase(scope: CoroutineScope) {
        ...
        val domainModel: DomainModel =
            entityMapper.mapNetworkToDomainModel(downloadedNetworkEntity!!)
        //getting cache Entities from DomainModel
        val shop: CacheShop = entityMapper.getShopFromDomainModel(domainModel)
        val categoriesList: List<CacheCategory> =
            entityMapper.getCacheCategoriesFromDomainModel(domainModel)
